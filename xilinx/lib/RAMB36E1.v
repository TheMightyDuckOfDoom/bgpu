...
module RAMB36E1 (CASCADEOUTA, CASCADEOUTB, DBITERR, DOADO, DOBDO, DOPADOP, DOPBDOP, ECCPARITY, RDADDRECC, SBITERR, 
    ...
    parameter string  RAM_EXTENSION_A = "NONE";
    parameter string  RAM_EXTENSION_B = "NONE";
    parameter string  RAM_MODE = "TDP";
    parameter string  RDADDR_COLLISION_HWCONFIG = "DELAYED_WRITE";
