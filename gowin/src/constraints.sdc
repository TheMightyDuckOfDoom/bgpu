...
create_clock -name clk_sys   -period 25.0 [get_nets  {clk_sys}]
create_clock -name clk_jtg   -period 50.0 [get_ports {jtag_tck_i}]

set_clock_groups -asynchronous -group [get_clocks {clk_jtg}] -group [get_clocks {clk_sys}] -group [get_clocks {clk_ext}]
