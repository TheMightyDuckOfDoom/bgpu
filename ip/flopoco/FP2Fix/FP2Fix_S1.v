...
module FP2Fix_S1(clk, rst, X, R, ov);
  ...
  rightshifter25_by_max_31_freq400_uid6 fxp_shifter (
    .clk(clk),
    .padbit(sign),
    .r(_04_),
    .rst(rst),
  ...
  intadder_25_freq400_uid4 negadder (
    .cin(sign),
    .clk(clk),
    .r(_17_),
    .rst(rst),
...
module intadder_25_freq400_uid4(clk, rst, x, y, cin, r);
  wire [24:0] _0_;
  wire [24:0] _1_;
  input cin;
  wire cin;
...
module rightshifter25_by_max_31_freq400_uid6(clk, rst, x, s, padbit, r);
  wire [25:0] _0_;
  wire [27:0] _1_;
  wire [31:0] _2_;
  wire [39:0] _3_;
