...
module IEEEFMA_S2(clk, rst, A, B, C, negateAB, negateC, RndMode, R);
  ...
  lzc_52_freq150_uid6 ieeefpfma_8_23_freq150_uid2leadingzerocounter (
    .clk(clk),
    .i(bigsumabslowerbits),
    .o(_135_),
    .rst(rst)
  );
  leftshifter76_by_max_75_freq150_uid8 normalizationshifter (
    .clk(clk),
    .r(_160_),
    .rst(rst),
    .s(normshiftvalue),
  ...
  rightshifter24_by_max_76_freq150_uid4 rightshiftercomponent (
    .clk(clk),
    .r(_093_),
    .rst(rst),
    .s(shiftvalue),
...
module leftshifter76_by_max_75_freq150_uid8(clk, rst, x, s, r);
  wire [76:0] _0_;
  wire [78:0] _1_;
  wire [82:0] _2_;
  wire [90:0] _3_;
...
module lzc_52_freq150_uid6(clk, rst, i, o);
  wire _00_;
  wire _01_;
  wire [30:0] _02_;
  wire _03_;
...
module rightshifter24_by_max_76_freq150_uid4(clk, rst, x, s, r);
  wire [24:0] _0_;
  wire [26:0] _1_;
  wire [30:0] _2_;
  wire [38:0] _3_;
